...
// A function to determine the marker size based on population
function markerSize(population) {
    return Math.sqrt(population) * 50;
}

// arrays to hold the city and state markers
let cityMarkers = [];
let stateMarkers = [];
...
// make a layer groups from the city and state marker arrays
