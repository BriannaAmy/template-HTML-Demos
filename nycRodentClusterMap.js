    ...
    function(data){
        ...
        for(let i = 0; i < data.length; i++){
            ...
            if(location){
                ...
                markers.addLayer(L.marker([location.coordinates[1],location.coordinates[0]]).bindPopup(data[i].descriptor));
            }
        }

        // call on addLayer() to add the marker cluster group to the map
