...
let australia = Object.values(data.australia); // gets the information from the austrailia key
...
// draw plot using australia data
function init()
{
    // set up the trace witht the australia data
    let trace = {
        values: australia,
        labels: categories,
        type: "pie"
