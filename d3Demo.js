...
// promises are in D3 which allow for us to determine what to do when we get info from an API
let dataPromise = d3.json(url01);   // calls on the API endpoint

// show what promise looks like
...
// we can use the inline function arrow as well
