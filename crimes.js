...
// adding a tile layer (the backgroud map image) to our map:
// we use the addTo() method to add objects to our map.
L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    addtribution: '&copy; <a href="https://www.openstreemap.org/copyright">OpenStreetMap</a> contributors'
}).addTo(map);
    ...
    function(geojson){
        ...
        var choroplethLayer = L.choropleth(geojson, {
            ...
            onEachFeature: function (feature, layer) {
                ...
                feature.properties.incidents.toString() + ' incidents')
            }
        }).addTo(map);
        ...
        legend.onAdd = function(map) {
            ...
            // the first (corresponds to the min) and last (corresponds to the max) color
            var colors = choroplethLayer.options.colors;

            // make an empty array from the lables
            var labels = [];
            ...
            // use .innerHTML to add the modifed ul content for the div
